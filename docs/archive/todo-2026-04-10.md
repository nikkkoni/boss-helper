...
> 基于 [review-2026-04-10.md](./review-2026-04-10.md)（2026-04-10）重排，只保留当前未完成且需要继续跟进的事项。  
...
>
> Historical snapshot only. This archive predates the later delivery-only cleanup; active code has since removed the chat/websocket/greeting files and behaviors referenced below.
