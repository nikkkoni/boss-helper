...
> Historical snapshot only. This review predates the later delivery-only cleanup; active code has since removed the chat/websocket/greeting stack referenced below.
