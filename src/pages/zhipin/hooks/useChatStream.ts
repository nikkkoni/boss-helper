...
import { AwesomeMessage, type TechwolfChatProtocol, type TechwolfMessage, type TechwolfMessageBody } from '@/composables/useWebSocket/type'
...
async function captureChatPayload(data: unknown) {
